...
ActiveRecord::Schema.define(version: 2020_06_25_144309) do
  ...
  create_table "answers", force: :cascade do |t|
    ...
    t.string "text", limit: 300, default: "", null: false
  ...
  create_table "badges", force: :cascade do |t|
    ...
    t.bigint "parameter_category_id"
    t.integer "parameter_number"
    t.string "parameter_string"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["parameter_category_id"], name: "index_badges_on_parameter_category_id"
  end
  ...
  add_foreign_key "badges", "categories", column: "parameter_category_id"
